      ...
      <View className="flex flex-1 items-start  mt-5 px-1">
        ...
        <View className="email-verification w-full">
          ...
          <FormField
            ...
            title="code"
            placeholder="674534"
            onChangeText={(e: string) => setForm({ ...form, code: e })}
          />
          <Text className="text-white/80 mt-5 text-base  font-semibold">
            We have sent you 6-digit verification code to your email address.
          </Text>
        </View>
